...
<body>
    <div class="w3-padding w3-content w3-text-grey w3-third w3-display-middle"> <?php $servername = "localhost";
                                                                                $username = "root";
                                                                                $password = "usbw";
                                                                                $dbname = "pwii";
                                                                                ...
                                                                                if ($conexao->query($sql) === TRUE) {
                                                                                    echo '             <a href="listar.php">                 <h1 class="w3-button w3teal">Amigo Atualizado com sucesso! </h1>             </a>              ';
