...
$bd = "pwii";
    ...
    try {
        ...
        echo '<a href="listar.php"><h1 class="w3-button w3-indigo">Produto Excluído com sucesso!</h1></a>';
    } catch (PDOException $e) {
        echo '<a href="listar.php"><h1 class="w3-button w3-indigo">ERRO! ' . $e->getMessage() . '</h1></a>';
    }
    ?>
</div>
</body>
